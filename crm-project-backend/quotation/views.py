...
def quotation_pdf_view(request, quotation_id):
    ...
    try:
        quotation = Quotation.objects.select_related('customer').get(id=quotation_id)  # Removed 'site'
...
class QuotationViewSet(viewsets.ModelViewSet):
    ...
    def download_pdf(self, request, pk=None):
        try:
            quotation = Quotation.objects.select_related('customer').get(pk=pk)  # Removed 'site'
